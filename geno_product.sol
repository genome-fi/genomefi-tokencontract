...
// File: contracts/GenoCoin.sol
pragma solidity >=0.5.0;

/**
 * @title GenoCoin contract 
 */
contract GenomeFi is ERC20Capped, ERC20Detailed {
    uint noOfTokens = 1_000_000_000; 

    // Address of geno coin vault
    // The vault will have all the geno coin issued.
    address internal vault;

    // Address of geno coin owner
    // The owner can change admin and vault address.
    address internal owner;

    // Address of geno coin admin
     ...
     *
     * Cap the mintable amount to 3B(0)
     *
     */
    constructor (string memory _symbol, string memory _name, address _owner,
        address _admin, address _vault) ERC20Detailed(_name, _symbol, 18) ERC20Capped(1_000_000_000_000_000_000_000_000_000)
    public {
     ...
     *
     * The _from's geno balance should be larger than the reserved amount(reserves[_from]) plus _value.
     *
